...
import servicesImage from "../../assets/download.jpeg";
import cryptoImage from "../../assets/crypto.jpeg";
            ...
            <div>
                <main className="py-6 px-4 sm:p-6 md:py-10 md:px-8">
                    <div className="max-w-4xl mx-auto grid grid-cols-1 lg:max-w-5xl lg:gap-x-20 lg:grid-cols-2">
                        ...
                        <div className="mt-4 col-start-1 row-start-3 self-center sm:mt-0 sm:col-start-2 sm:row-start-2 sm:row-span-2 lg:mt-6 lg:col-start-1 lg:row-start-4 lg:row-end-5">
                            <button type="button" className="bg-indigo-600 text-white text-sm leading-6 font-medium py-2 px-3 rounded-lg"
                                onClick={handleencryptNowClick}>
                                Try encrypt
                            </button>
                        </div>
                        <p className="mt-4 text-sm leading-6 col-start-1 sm:col-span-2 lg:mt-6 lg:row-start-3 lg:col-span-1 dark:text-slate-400">
                            Ensuring the security and privacy of your digital experience is paramount to our platform. We offer a robust suite of protective measures 
                                                        tailored to safeguard your online activities. Our capabilities include advanced virus scanning, bolstered by encryption and decryption features 
                                                        to enhance privacy. Additionally, our platform delivers real-time defense against viruses, malware, and ransomware, coupled with cutting-edge 
                                                        detection and removal techniques. Enjoy secure web browsing with built-in web filtering mechanisms that proactively thwart malicious sites and 
                                                        phishing attempts. Benefit from seamless updates to ensure your software remains up-to-date across various devices, including PCs, and mobile platforms.
                        </p>
                    </div>
                </main>
            </div>
